...
class Student:
    ...
    def __init__(self,root):
       ...
       pb.studentData()
       def iExit():
           iExit=tkinter.messagebox.askyesno("GNE'Students","confirm if you want to exit")
           if iExit>0:
	           root.destroy()
	           return
       def clearData():
       ...
       MainFrame.grid()  #THIS IS MAIN FRAME OF OUR WINDOW
       ...
       self.lblTit=Label(TitFrame,font=('arial',25,'bold'),text="GURU NANAK DEV ENGINEERING,LUDHIANA ",bg="red",fg="black")
       self.lblTit.grid()

       self.lblTit=Label(TitFrame,font=('arial',12),text="(An Autonomous college, affiliated with Punjab Technical University)",bg="red",fg="black")
       self.lblTit.grid()
